...
public class Directory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        NYUPerson mattParker = new NYUPerson("Matt Parker",
                                              "mp612");
        NYUPerson matt = new NYUStaff("Matt Parker", "mp000",999999.0f);
        NYUPerson hoisen = new NYUStudent("Hoi Sen Wong", "hw3160", 4.0f, 36);
        NYUPerson möw = new NYUFaculty("Möw", "mw000", "604", 9999.0f);
        NYUPerson ruofu = new NYUMaster("Ruofu Sun", "rs0001", "Master", "Year One", 4.0f, 36);
        NYUPerson jiaxian = new NYUUndergrad("Jiaxian Li", "jl002", "Undergraduate", "Year Three", 4.0f, 36);
        
        nyuPeopleList.Add(mattParker); //add mattParker to the nyuPeopleList
        nyuPeopleList.Add(hoisen);
        nyuPeopleList.Add(matt);
        nyuPeopleList.Add(möw);
        nyuPeopleList.Add(ruofu);
        nyuPeopleList.Add(jiaxian);
